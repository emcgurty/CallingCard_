...
document.getElementById('perspective_detail').style.display = 'inline';
document.getElementById('signature_detail').style.display = 'none';
}
...
document.getElementById('perspective_detail').style.display = 'none';
document.getElementById('signature_detail').style.display = 'inline';
}
...
//  eventually will do text_are character counts
function CountRemaining(field, max) {

if (document.getElementById)  {
   var char_count = document.getElementById(field).value.length; 
   document.getElementById('remaining').value = 'Remaining: ' + (max - char_count);
   }
